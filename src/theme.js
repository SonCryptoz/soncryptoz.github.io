...
export const materialDarkTheme = {
    body: "#060912",             /* nền tối */
    text: "#d6c8ff",             /* trắng xanh tinh tế – dễ đọc */
    expTxtColor: "#0D1117",      /* text trên nền sáng */
    highlight: "#22D3EE",        /* cyan tươi, dùng cho điểm nhấn */
    dark: "#6441a1",             /* đen sâu nhất */
    secondaryText: "#E8F4FD",    /* indigo-violet nhạt – phụ đề */
    imageHighlight: "#22D3EE",   /* violet rực cho icon/accent */
    compImgHighlight: "#1E293B", /* card nền tối */
    jacketColor: "#6366F1",      /* indigo – logo / jacket */
    headerColor: "#6366F133",    /* indigo mờ cho header card */
    splashBg: "#0F172A",         /* navy đậm splash */
    navUnderline: "#22D3EE",     /* gạch chân nav = cyan */
    cardBorder: "#1E3A5F",       /* viền card xanh đậm */
    cardShadow: "rgba(34,211,238,0.10)", /* bóng đổ cyan */
    bulletColor: "#22D3EE",      /* dấu bullet trong skills */
};
...
export const chosenTheme = materialDarkTheme; // Change this to switch themes
